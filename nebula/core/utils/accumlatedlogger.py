...
class AccumaltedLogger(TensorBoardLogger):
    ...
    def aggregate_nodes_data(self):
        Total_nodes_energy_consumption, step_energy = read_tensorboard_data(
            os.path.join(self._root_dir, self._name), "Sustainability/Total_energy_consumption"
        )

        Total_nodes_carbon_emission, step_carbon = read_tensorboard_data(
            os.path.join(self._root_dir, self._name), "Sustainability/Total_carbon_emission"
        )
        ...
        metrics = {
            "Sustainability/Total_nodes_energy_consumption": Total_nodes_energy_consumption,
